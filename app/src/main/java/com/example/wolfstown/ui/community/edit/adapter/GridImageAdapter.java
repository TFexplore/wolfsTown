package com.example.wolfstown.ui.community.edit.adapter;
...
import com.example.wolfstown.ui.community.edit.adapter.listener.OnItemLongClickListener;
...
public class GridImageAdapter extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mImg = view.findViewById(com.example.wolfstown.R.id.fiv);
            mIvDel = view.findViewById(com.example.wolfstown.R.id.iv_del);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(com.example.wolfstown.R.layout.edit_imag_item, viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(com.example.wolfstown.R.drawable.ic_add_image);
            ...
            if (chooseModel == SelectMimeType.ofAudio()) {
                ...
                Glide.with(viewHolder.itemView.getContext())
                        .load(PictureMimeType.isContent(path) && !media.isCut() && !media.isCompressed() ? Uri.parse(path)
                                : path)
                        .centerCrop()
                        .placeholder(com.example.wolfstown.R.color.app_color_f6)
